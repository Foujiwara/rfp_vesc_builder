...
#define HW_NAME					"C350 RAGE MECHANICS 6.2"
...
#define MCCONF_L_MAX_ABS_CURRENT		410.0	// The maximum absolute current above which a fault is generated
#endif
...
// Setting limits
#define HW_LIM_CURRENT			-300.0, 400.0
#define HW_LIM_CURRENT_IN		-120.0, 300.0
#define HW_LIM_CURRENT_ABS		0.0, 410.0
#define HW_LIM_VIN				0.0, 90.0
